...
contract StarNotary is ERC721 {
  ...
  // Implement Task 1 lookUptokenIdToStarInfo
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        address starSender1 = ownerOf(_tokenId1);
        address starSender2 = ownerOf(_tokenId2);
        //2. You don't have to check for the price of the token (star)
        require(msg.sender == starSender1  || msg.sender == starSender2, "You don't these stars");
        //3. Get the owner of the two tokens (ownerOf(_tokenId1), ownerOf(_tokenId1)
        //4. Use _transferFrom function to exchange the tokens.
        _transferFrom(starSender1, starSender2, _tokenId1);
        _transferFrom(starSender2, starSender1, _tokenId2);
    }

    // Implement Task 1 Transfer Stars
    function transferStar(address _toAddress, uint256 _tokenId) public {
        //1. Check if the sender is the ownerOf(_tokenId)
        address starSender = ownerOf(_tokenId);
        require(msg.sender == starSender, "You don't own these stars!");
